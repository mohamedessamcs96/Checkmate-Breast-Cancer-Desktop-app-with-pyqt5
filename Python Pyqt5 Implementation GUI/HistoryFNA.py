...
# Form implementation generated from reading ui file 'HistoryF.ui'
#
...
import sqlite3
class Ui_HistoryFNA(object):
    
    global connection, PatientID
    PatientID=""
    connection=sqlite3.connect("sqlitedatabase2.db")   
    """
    ...
    def DAWarnning(self):
        self.ShowMessageBox('Warning',"This Page doesn't avilable for you ")
...
"}")
        ...
        self.FNAList = QtWidgets.QTableWidget(self.frame)
        self.FNAList.setGeometry(QtCore.QRect(10, 280, 1021, 321))
        self.FNAList.setColumnCount(13)
        self.FNAList.setObjectName("FNAList")
        self.FNAList.setRowCount(0)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(10, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(11, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.FNAList.setHorizontalHeaderItem(12, item)
        self.FNAList.horizontalHeader().setDefaultSectionSize(125)
        self.FNAList.horizontalHeader().setMinimumSectionSize(30)
        self.FNAList.verticalHeader().setMinimumSectionSize(19)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Fine Needle Aspirate patient history"))
        ...
        item = self.FNAList.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Date"))
        item = self.FNAList.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "FNA Result"))
        item = self.FNAList.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Mean area"))
        item = self.FNAList.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Area error"))
        item = self.FNAList.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Worst area"))
        item = self.FNAList.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Mean radius"))
        item = self.FNAList.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Radius error"))
        item = self.FNAList.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "Breast"))
        item = self.FNAList.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "Breast-quad"))
        item = self.FNAList.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "Tumor size"))
        item = self.FNAList.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "Deg-malig"))
        item = self.FNAList.horizontalHeaderItem(11)
        item.setText(_translate("MainWindow", "Inv-Falsedes"))
        item = self.FNAList.horizontalHeaderItem(12)
