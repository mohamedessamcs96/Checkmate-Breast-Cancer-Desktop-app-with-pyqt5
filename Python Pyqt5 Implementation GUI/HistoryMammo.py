...
# Form implementation generated from reading ui file 'HistoryM.ui'
#
...
import sqlite3
from CancerInfoMammo import Ui_CancerInfo

class Ui_HistoryMammo(object):
    ...
    def loadtableData(self):
        print(PatientID)   
        result2 =connection.execute("SELECT DATE,MAMORESULT,BIRADS,MASSHAPE,MASSSMARGIN,MASSDENISITY,BREAST,BREASTSQUAD,TUMORSIZE,DEGMALIG,IRRADIAT,INVFALSEDES FROM MOMGRAPH WHERE PATIENTID=?",(PatientID,))
        ...
        print(result2)
        self.MammoList.setRowCount(0)
        for row_number,row_data in enumerate(result2):
            self.MammoList.insertRow(row_number)
            for column_number,data in enumerate(row_data):
                self.MammoList.setItem(row_number,column_number,QtWidgets.QTableWidgetItem(str(data)))
...
"}")
        ...
        self.MammoList = QtWidgets.QTableWidget(self.frame)
        self.MammoList.setGeometry(QtCore.QRect(10, 280, 1021, 321))
        self.MammoList.setColumnCount(12)
        self.MammoList.setObjectName("MammoList")
        self.MammoList.setRowCount(0)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(10, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter|QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        font.setWeight(75)
        item.setFont(font)
        self.MammoList.setHorizontalHeaderItem(11, item)
        self.MammoList.horizontalHeader().setDefaultSectionSize(145)
        self.MammoList.horizontalHeader().setMinimumSectionSize(30)
        self.MammoList.verticalHeader().setMinimumSectionSize(19)
...
"}")
        ...
        self.MammoB.clicked.connect(self.openCancerInfoWindowPage)
        self.DiagnosisB.clicked.connect(self.DAWarnning)
        self.FNAB.clicked.connect(self.SPWarnning)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Mammography patient history"))
        ...
        item = self.MammoList.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Date"))
        item = self.MammoList.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Mammography result"))
        item = self.MammoList.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "BI-RADS "))
        item = self.MammoList.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Mass shape"))
        item = self.MammoList.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Mass margin"))
        item = self.MammoList.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Mass density"))
        item = self.MammoList.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Breast"))
        item = self.MammoList.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "Breast-quad"))
        item = self.MammoList.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "Tumor size"))
        item = self.MammoList.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "Deg-malig"))
        item = self.MammoList.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "Inv-Falsedes"))
        item = self.MammoList.horizontalHeaderItem(11)
        item.setText(_translate("MainWindow", "Irradiat"))
